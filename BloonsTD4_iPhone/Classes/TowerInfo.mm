...
CTowerInfo::CTowerInfo() {
  SetTowerInfo(&this->_towerInfoDartMonkey, eTOWER_TYPE_DART_MONKEY, "Dart Monkey", 200, 100, 161, 
  ...
  SetTowerInfo(&this->_towerInfoTackShooter, eTOWER_TYPE_TACK_SHOOTER, "Tack Shooter", 360, 70, 70, 
  ...
  SetTowerInfo(&this->_towerInfoBoomerang, eTOWER_TYPE_BOOMERANG, "Boomerang Thrower", 400, 130, 520
  ...
  SetTowerInfo(&this->_towerInfoBombTower, eTOWER_TYPE_BOMB_TOWER, "Bomb Tower", 700, 120, 234, 520.0
  ...
  SetTowerInfo(&this->_towerInfoIceTower, eTOWER_TYPE_ICE_TOWER, "Ice Tower", 380, 60, 60, 0.0, 2.125, 
  ...
  SetTowerInfo(&this->_towerInfoGlueTower, eTOWER_TYPE_GLUE_TOWER, "Glue Gunner", 300, 0x8c, 0xe1, 
  ...
  SetTowerInfo(&this->_towerInfoBeacon, eTOWER_TYPE_BEACON, "Monkey Beacon", 1000, 0x78, 0, 0.0, 0.0, 0
                  , 0, eTARGET_TYPE_NONE, 
  ...
  SetTowerInfo(&this->_towerInfoSuperMonkey, eTOWER_TYPE_SUPER_MONKEY, "Super Monkey", 4000, 140, 
  ...
  SetTowerInfo(&this->_towerInfoMortarTower, eTOWER_TYPE_MORTAR_TOWER, "Mortar Tower", 825, 0, 0, 0.0
  ...
  SetTowerInfo(&this->_towerInfoMonkeyAce, eTOWER_TYPE_MONKEY_ACE, "Monkey Ace", 900, 250, 320, 320.0
  ...
  SetTowerInfo(&this->_towerInfoApprentice, eTOWER_TYPE_APPRENTICE, "Monkey Apprentice", 550, 120, 
  ...
  SetTowerInfo(&this->_towerInfoFarm, eTOWER_TYPE_FARM, "Banana Farm", 1000, 0, 0, 0.0, 0.0, 0, 0, 
                  eTARGET_TYPE_NONE, 
  ...
  SetTowerInfo(&this->_towerInfoMonkeyBuccaneer, eTOWER_TYPE_MONKEY_BUCCANEER, "Monkey Buccaneer"
  ...
  SetTowerInfo(&this->_towerInfoRoadGlue, eTOWER_TYPE_ROAD_GLUE, "Monkey Glue", 10, 0x12, 0x12, 0.0, 
  ...
  SetTowerInfo(&this->_towerInfoRoadTacks, eTOWER_TYPE_ROAD_TACKS, "Road Spikes", 0x1e, 23, 0x17, 0.0
                  , 0.875, 10, 0, eTARGET_TYPE_NONE, 
                  "Place these road spikes on the track to pop bloons. Can pop 10 bloons before wearing out"
                  , "Upgrade 1 Name", "Upgrade 2 Name", "Upgrade 3 Name", "Upgrade 4 Name", 9000, 9000, 9000, 
                  9000, "Upgrade 1 text", "Upgrade 2 text", "Upgrade 3 text", "Upgrade 4 text");
  SetTowerInfo(&this->_towerInfoPineapple, eTOWER_TYPE_PINEAPPLE, "Pineapple", 0x19, 18, 18, 0.0, 
                  ...
                  , "Upgrade 1 Name", "Upgrade 2 Name", "Upgrade 3 Name", "Upgrade 4 Name", 9000, 9000, 9000, 
                  9000, "Upgrade 1 text", "Upgrade 2 text", "Upgrade 3 text", "Upgrade 4 text");
  SetTowerInfo(&this->_towerInfoMonkeyTemple, eTOWER_TYPE_MONKEY_TEMPLE, "Temple", 0, 480, 480, 
  ...
  SetTowerInfo(&this->_towerInfoDartling, eTOWER_TYPE_DARTLING, "Dartling Gun", 0x4e2, 100, 600, 
  ...
  SetTowerInfo(&this->_towerInfoSpikeFactory, eTOWER_TYPE_SPIKE_FACTORY, "Spike Factory", 700, 110, 
  ...
  SetTowerInfo(&this->_towerInfoBeeKeeper, eTOWER_TYPE_BEE_KEEPER, "Bee Keeper", 700, 150, 100000, 
