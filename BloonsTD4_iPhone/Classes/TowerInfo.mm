...
CTowerInfo::CTowerInfo() {
  SetTowerInfo(this,_towerInfoDartMonkey,eTOWER_TYPE_DART_MONKEY,"Dart Monkey",
  ...
  SetTowerInfo(this,_towerInfoTackShooter,eTOWER_TYPE_TACK_SHOOTER,"Tack Shooter",
  ...
  SetTowerInfo(this,_towerInfoBoomerang,eTOWER_TYPE_BOOMERANG,"Boomerang Thrower",
  ...
  SetTowerInfo(this,_towerInfoBombTower,eTOWER_TYPE_BOMB_TOWER,"Bomb Tower",
  ...
  SetTowerInfo(this,_towerInfoIceTower,eTOWER_TYPE_ICE_TOWER,"Ice Tower",
  ...
  SetTowerInfo(this,_towerInfoGlueTower,eTOWER_TYPE_GLUE_TOWER,"Glue Gunner",
  ...
  SetTowerInfo(this,_towerInfoBeacon,eTOWER_TYPE_BEACON,"Monkey Beacon",
  ...
  SetTowerInfo(this,_towerInfoSuperMonkey,eTOWER_TYPE_SUPER_MONKEY,"Super Monkey",
  ...
  SetTowerInfo(this,_towerInfoMortarTower,eTOWER_TYPE_MORTAR_TOWER,"Mortar Tower",
  ...
  SetTowerInfo(this,_towerInfoMonkeyAce,eTOWER_TYPE_MONKEY_ACE,"Monkey Ace",
  ...
  SetTowerInfo(this,_towerInfoApprentice,eTOWER_TYPE_APPRENTICE,"Monkey Apprentice",
  ...
  SetTowerInfo(this,_towerInfoFarm,eTOWER_TYPE_FARM,"Banana Farm",
  ...
  SetTowerInfo(this,_towerInfoRoadGlue,eTOWER_TYPE_ROAD_GLUE,"Monkey Glue",
  ...
  SetTowerInfo(this,_towerInfoRoadTacks,eTOWER_TYPE_ROAD_TACKS,"Road Spikes",
               ...
               9000,9000,9000,9000,
               "Upgrade 1 text","Upgrade 2 text","Upgrade 3 text","Upgrade 4 text");
  SetTowerInfo(this,_towerInfoPineapple,eTOWER_TYPE_PINEAPPLE,"Pineapple",
               ...
               9000,9000,9000,9000,
               "Upgrade 1 text","Upgrade 2 text","Upgrade 3 text","Upgrade 4 text");
  SetTowerInfo(this,_towerInfoMonkeyTemple,eTOWER_TYPE_MONKEY_TEMPLE,"Temple",
               0,480,480,1200.0,0.1,100,0,eTARGET_TYPE_FIRST,
               "This should never be displayed as you cant select this tower.",
               "Upgrade 1 Name","Upgrade 2 Name","Upgrade 3 Name","Upgrade 4 Name",
               9000,9000,9000,9000,
               "Upgrade 1 text","Upgrade 2 text","Upgrade 3 text","Upgrade 4 text");
  SetTowerInfo(this,_towerInfoDartling,eTOWER_TYPE_DARTLING,"Dartling Gun",
  ...
  SetTowerInfo(this,_towerInfoSpikeFactory,eTOWER_TYPE_SPIKE_FACTORY,"Spike Factory",
  ...
  SetTowerInfo(this,_towerInfoBeeKeeper,eTOWER_TYPE_BEE_KEEPER,"Bee Keeper",
